...
export default function SignCharacteristic({
  ...
  console.log(
    "🚀 ~ file: SignCharacteristic.tsx:156 ~ aboutUs ~ aboutUs:",
    aboutUs
  );
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`md:h-[488px] duration-1000 md:opacity-0 transition-all md:w-[680px] max-md:mt-16 flex ${characteristicType === 1 ? "md:opacity-100" : ""
                      ...
                      <div
                        className={`md:h-[488px] ${characteristicType === 3 ? "md:opacity-100" : ""
