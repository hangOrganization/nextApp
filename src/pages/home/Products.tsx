...
export default function Products({ value, setValue }: ProductsProps) {
  ...
  return (
    <div
      id="Products"
      className="flex mt-[250px] pt-[74px] box2 w-screen pl-[136px] pr-[120px]"
      onWheelCapture={_.debounce((e: any) => {
        if (value === 0) {
          if (e.deltaY > 0) {
            setValue(1);
          }
    ...
    >
      <div className="flex w-[100%] items-center justify-between">
        <ProductsBox>
          <p className="font-extrabold text-[56px] leading-[160%] text-[#1a1a1a]">
            产品体系
          </p>
          <p className="font-medium mt-4 text-[24px] uppercase font-[Lexend] leading-[160%] text-[#1a1a1a]">
            System of products
          </p>
        </ProductsBox>
        <div className="h-[530px] overflow-hidden">
          ...
          >
            <ProductsRightBox>
              <p className="text-[38px] text-[#FF4B00] font-medium leading-[160%]">
                主体课程
              </p>
              <div className="flex gap-2 mt-[35px] items-center">
                <p className="text-[20px] leading-[160%] text-[#cccccc] font-extralight font-[Lexend]">
                  +
                </p>
                <p className="text-[20px] leading-[160%] text-[#cccccc] uppercase font-extralight font-[Lexend]">
                  Foundation
                </p>
                <p className="text-[20px] leading-[160%] text-[#cccccc] font-light">
                  音乐启蒙课
                </p>
              </div>
            ...
            <ProductsRightBox>
              <p className="text-[38px] mb-[35px] text-[#FF4B00] font-medium leading-[160%]">
                主体课程综合增值服务
              </p>
              <div className="flex h-[404px] gap-y-[30px] gap-x-12 flex-col flex-wrap">
                <div className="flex gap-2 items-center">
                  ...
                  <div
                    ...
                    className="text-[14px] leading-[160%] text-[#FF4B00] uppercase font-bold rounded-[8px] py-[2] px-2 font-[Lexend]"
                  >
                    vip
                  </div>
                </div>
