...
import icon_MA from '@/assets/image/svg/icon-MA.svg'
...
const NameOur = styled.p`
    ...
    text-shadow: 2px 0px 0px #0000FF;
 `
        ...
        <OurTeamBox>
            <OurTeamBg>
                <OurTeamBlur>
                    ...
                    <div className="flex gap-[67px] my-20">
                        <CardBox>
                            <CardFilterBox>
                                <div className='p-6 pr-[17px] w-[253px] absolute bottom-0 right-[-51px] h-[184px] ml-[51px] bg-[#FFFFFF]'>
                                    <NameOur>MA</NameOur>
                                    <p className='font-normal text-[16px] mt-2 mb-4 leading-[120%] uppercase text-[#1a1a1a]'>音乐制作导师</p>
                                    <p className='font-light text-[12px] leading-[180%] uppercase opacity-80 text-[#1a1a1a]'>  日本NHK电视台纪录片《平安京》作曲 中央电视台纪录片《家园》作曲</p>
                                </div>
                            </CardFilterBox>
                        </CardBox>
                        <CardBox>
                    ...
                    <div style={{ border: "1px solid #FFFFFF" }} className='p-4 text-[16px] leading-[120%] w-[226px] font-normal mx-auto pl-[30px] pr-[15px] flex items-center rounded-[64px]'>
                        观看导师精彩作品
                        <div style={{ border: "1px solid #FFFFFF" }} className='w-[36px] ml-[14px] items-center justify-center flex rounded-full h-[36px]'>
                            <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 15C9 15 11.9412 8 19 8C11.9412 8 9 1 9 1" stroke="white" stroke-width="1.6" />
                                <path d="M18 8L0 8" stroke="white" stroke-width="1.6" />
                            </svg>
                        </div>
                    </div>
                </OurTeamBlur>
