...
const SpecializeBox = styled.div`
    background: linear-gradient(180deg, #1A1A1A 0%, rgba(26, 26, 26, 0.46) 48.22%, #1A1A1A 100%), url(${specialize_bg.src}) ;
    width: 100vw;
    padding-top: 460px;
...
export default function Specialize() {
    ...
    return (
        <SpecializeBox className='flex justify-center h-[1309px] relative z-[-111111] w-screen overflow-hidden mt-[-190px] flex-col items-center'>
            <div className=''>
                <div style={{ background: 'rgba(26, 26, 26, 0.90)', backdropFilter: 'blur(40px)' }} className='md:px-[160px] md:!backdrop-blur-none md:!bg-transparent max-md:pb-1 max-md:pt-[21px] max-md:flex-col max-md:justify-center max-md:items-center flex justify-between'>
                    ...
                    <div className='flex flex-col max-md:px-[31px] max-md:w-screen max-md:mt-8 md:justify-end md:items-end'>
                        <div className='flex gap-4 max-md:justify-between items-end'>
                            <div className={`md:w-[200px] ${musicGenre === 1 ? 'md:mb-2' : ''} transition-all duration-300 cursor-pointer text-center`} onClick={() => setMusicGenre(1)}>
                                <p className={`text-[24px] ${musicGenre === 1 ? 'font-[200]' : 'font-[100] max-md:font-light'} max-md:text-[14px] font-[200] leading-[160%]`}>现代音乐类</p>
                            </div>
                            <div className={`md:w-[200px] ${musicGenre === 2 ? 'md:mb-2' : ''} transition-all duration-300 cursor-pointer text-center`} onClick={() => setMusicGenre(2)}>
                                <p className={`text-[24px] ${musicGenre === 2 ? 'font-[200]' : 'font-[100] max-md:font-light'} max-md:text-[14px] font-[200] leading-[160%]`}>古典音乐类</p>
                            </div>
                            <div className={`md:w-[200px] ${musicGenre === 3 ? 'md:mb-2' : ''} transition-all duration-300 cursor-pointer text-center`} onClick={() => setMusicGenre(3)}>
                                <p className={`text-[24px] ${musicGenre === 3 ? 'font-[200]' : 'font-[100] max-md:font-light'} max-md:text-[14px] font-[200] leading-[160%]`}>音乐理论及应用类</p>
                            </div>
                        </div>
                        <div className={`w-[86px] transition-all max-md:hidden duration-500 ${musicGenre === 1 ? 'translate-x-[-488.5px]' : musicGenre === 2 ? 'translate-x-[-272.5px]' : 'translate-x-[-56.5px]'} `} style={{ border: "0.5px solid #FFFFFF" }}></div>
                                        ...
                                        <div className='flex flex-col max-md:h-[390px] h-[469px] flex-wrap md:pl-2 max-md:gap-y-[11px] max-md:gap-x-6 gap-3 md:gap-x-8'>
                                            {modernMusicHotMajor.map((el: any, index: number) => (
                                                <div className='max-md:w-[124px] max-md:text-center' key={`${index}-${el.englishTitle}-modernMusicHotMajor`}>
                                                    <p className='text-[16px] max-md:text-[14px] font-[400] text-[#1A1A1A] leading-[160%]'>{el.title}</p>
                                                    <p className='text-[10px] max-md:leading-[13px] text-ellipsis overflow-hidden line-clamp-2 font-[200] font-[Lexend] text-[#1A1A1A] opacity-40 leading-[160%]'>{el.englishTitle}</p>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                        ...
                                        <div className='flex max-md:mt-4 mt-[24px] justify-between'>
                                            <div className='flex h-[138px] max-md:w-[163px] max-md:h-[171px] flex-wrap flex-col max-md:gap-x-6 gap-x-12 gap-y-[11.75px]'>
                                                {modernMusicSchool[0].map((el: any, index: number) => (
                                                    <p key={`${index}-modernMusicSchool`} className='text-[13px] max-md:w-[163px] max-md:text-ellipsis max-md:overflow-hidden max-md:line-clamp-1 max-md:font-light max-md:text-[12px] max-md:leading-[14.3px] leading-[140%] text-[#3E3E3E] font-[400] '>
                                                        {el}
                                                    </p>
                                                ))}
                                            </div>
                                        ...
                                        <div className='flex max-md:mt-4 mt-[24px]'>
                                            <div className='flex flex-col max-md:h-[97px] h-[138px] gap-x-[137px] max-md:gap-x-[100px] flex-wrap gap-y-[11.75px]'>
                                                {modernMusicSchool[1].map((el: any, index: number) => (
                                                    <p key={`${index}-modernMusicSchool-Japan and South Korea`} className='text-[13px] max-md:text-[11px] max-md:leading-[15.4px] leading-[140%] max-md:font-light text-[#3E3E3E] font-[400] '>
                                                        {el}
                                                    </p>
                                                ))}
                                            </div>
                                        ...
                                        <div className='flex flex-col max-md:h-[198px] h-[264px] flex-wrap md:pl-2 max-md:gap-x-[20px] md:gap-x-[65px] max-md:gap-y-[12px] gap-y-[28px]'>
                                            {classicalMusicHotMajor.map((el: any, index: number) => (
                                                <div className='max-md:w-[126px] max-md:text-center' key={`${index}-${el.englishTitle}-classicalMusicHotMajor`}>
                                                    <p className='text-[16px] max-md:text-[14px] font-[400] text-[#1A1A1A] leading-[160%]'>{el.title}</p>
                                                    <p className='text-[12px] text-ellipsis overflow-hidden line-clamp-2 max-md:leading-[13px] font-[200] font-[Lexend] text-[#1A1A1A] opacity-40 leading-[160%]'>{el.englishTitle}</p>
                                                </div>
                                            ))}
                                        ...
                                        <div className='flex mt-[24px] max-md:mt-4 md:justify-between'>
                                            <div className='flex max-md:h-[170px] h-[138px] flex-wrap flex-col max-md:gap-x-[68px] gap-x-[86px] max-md:gap-y-[11px] gap-y-[11.75px]'>
                                                {classicalMusicSchool[0].map((el: any, index: number) => (
                                                    <p key={`${index}-classicalMusicSchool`} className='text-[13px] leading-[140%] text-[#3E3E3E]  max-md:text-[11px] max-md:leading-[14.3px] max-md:font-light  font-[400] '>
                                                        {el}
                                                    </p>
                                                ))}
                                            </div>
                                        ...
                                        <div className='flex max-md:mt-4 mt-[24px]'>
                                            <div className='flex flex-col max-md:h-[170px] h-[138px] gap-x-[47.5px] max-md:gap-x-[20px] flex-wrap max-md:gap-y-[11px] gap-y-[11.75px]'>
                                                {classicalMusicSchool[1].map((el: any, index: number) => (
                                                    <p key={`${index}-classicalMusicSchool-Japan and South Korea`} className='text-[13px] max-md:text-[11px] max-md:leading-[14.3px] max-md:font-light leading-[140%] text-[#3E3E3E] font-[400]'>
                                                        {el}
                                                    </p>
                                                ))}
                                            </div>
                                        ...
                                        <div className='flex max-md:mt-4 mt-[24px] md:justify-between'>
                                            <div className='flex max-md:h-[167px] max-md:w-[155px] h-[254px] flex-wrap flex-col max-md:gap-x-[24px] gap-x-[102px] max-md:gap-y-[11px] gap-y-[18px]'>
                                                {musicalTheorySchool.map((el: any, index: number) => (
                                                    <p key={`${index}-musicalTheorySchool`} className='text-[13px] max-md:text-[11px] max-md:leading-[14.3px] max-md:font-light leading-[140%] text-[#3E3E3E] font-[400]'>
                                                        {el}
                                                    </p>
                                                ))}
                                            </div>
