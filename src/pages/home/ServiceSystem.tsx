...
import service_bg from "../../assets/image/svg/service1-bg.svg";
...
export default function ServiceSystem() {
  return (
    <div className=" flex mt-[30px] items-center justify-center px-[120px]">
      <ServiceSystemBox>
        <PlanningBox>
          <p className="text-[32px] mr-[45px] mt-[3px] font-extrabold leading-[100%] text-[#0000ff]">
            规划端
          </p>
          <div className="flex gap-[28px]">
            <div>
              <p className="text-[18px] leading-[160%] font-normal text-[#1a1a1a]">
                入学基础评估
              </p>
              <p className="text-[18px] leading-[160%] my-4 font-normal text-[#1a1a1a]">
                留学时间规划
              </p>
              <p className="text-[18px] leading-[160%] font-normal text-[#1a1a1a]">
                作品集课程规划
        ...
        <div className="flex mt-[90px] justify-between">
          <TeachingBox>
            <div className="flex">
              <div>
                <p className="text-[18px] leading-[160%] mb-4 font-normal text-[#1a1a1a]">
                  主项目导师
                </p>
                <p className="text-[18px] leading-[160%] mb-4 font-normal text-[#1a1a1a]">
                  辅修课程导师
              ...
              <p className="text-[32px] ml-[48px] mt-[14px] font-extrabold leading-[100%] text-[#0000ff]">
                教学端
              </p>
            </div>
          </TeachingBox>
          <ServiceBox>
            <div>
              <p className="text-[54px] font-normal leading-[120%] font-['FusionPixel']">
                服务体系
              </p>
              <p className="text-[24px] font-normal leading-[160%] mt-[18px] uppercase tracking-[0.17em] font-['GuanZhi']">
                Service system
              </p>
            </div>
          </ServiceBox>
          <EducationalBox>
            ...
            <div
              ...
              className="flex"
            >
              <p className="text-[32px] mr-[38px] mt-[34px] font-extrabold leading-[100%] text-[#0000ff]">
                规划端
              </p>
              <div className="flex gap-[28px]">
                <div>
