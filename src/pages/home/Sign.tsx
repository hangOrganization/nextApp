...
export default function Sign({}: SignProps) {
  ...
  return (
    <div
      ...
      } max-md:pb-20 h-screen w-screen`}
      onWheel={(e: any) => {
    ...
    >
      <div className="w-screen flex z-[30] max-md:top-[50px] justify-center left-0 absolute">
        <div
        ...
        <Image className="md:hidden" src={mobile_moireFringe} alt="" />
      </div>
      <div className="md:h-[728px] z-40 relative">
        ...
        <div className=" relative z-20 flex justify-center items-center flex-col max-md:pt-[226px] pt-[302px] ">
          ...
          <video
            autoPlay
            muted
            className="mt-[70px] max-md:hidden max-md:mt-12 max-md:h-[21px] h-[49px]"
          >
            <source
