                    ...
                    <div className="flex min-h-full items-center justify-center text-center">
                        ...
                        >
                            ...
                            >
                                ...
                                className="mySwiper">
                                    {list.map((el) => (
                                        <SwiperSlide className=" flex justify-center items-center" key={`${el.index}--mySwiper`}>
                                            <div className="flex relative h-screen w-screen justify-center items-center">
                                                <Image className="flex justify-center items-center" src={el.image} alt="" />
                                            </div>
                                            <p className="absolute left-4 bottom-8 font-light text-ellipsis overflow-hidden line-clamp-1 text-[20px] leading-[180%]">{el.name}</p>
                                        </SwiperSlide>))
                                    }
                                </Swiper>
                            </Dialog.Panel>
