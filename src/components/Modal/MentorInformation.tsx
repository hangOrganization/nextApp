            ...
            <Dialog as="div" className="relative z-[1000000]" onClose={closeModal}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-screen h-screen items-end pt-20 justify-center text-center">
                        ...
                        >
                            <Panel className="w-full min-h-full h-full transform overflow-auto p-12 text-left align-middle shadow-xl transition-all">
                                <Dialog.Title
                                    as="h3"
                                ...
                                <div className=" mx-auto h-full pt-10 w-[1200px]">
                                    <div className=" flex justify-between">
                                        ...
                                        <div className='max-h-full flex flex-col gap-y-4 h-full pb-6'>
                                            {teachers[textValue].detailed.map((el: any) => (
                                                <div key={`${teachers[textValue].value}-${teachers[textValue].name}`} className='text-[#1A1A1A] w-[642px] text-[14px] leading-[180%] font-light text-justify'>
                                                    {el}
                                                </div>
                                            ))}
