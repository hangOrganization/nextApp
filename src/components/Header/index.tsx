  ...
  return (
    <div className="fixed z-[10000] w-screen pl-[48px] pr-6 py-4 left-0 flex items-center justify-between top-0">
      ...
      <div className="flex gap-4 items-center">
        ...
        <div
          className="py-4 cursor-pointer text-[14px] leading-[100%] opacity-80 px-6 font-light"
        ...
        <div
          ...
          className="py-4 rounded-2xl cursor-pointer text-[14px] leading-[100%] opacity-80 px-6 font-light"
        >
          校区环境
        </div>
        <div
